...
export const PawSvg = ({ size, fill = '#000000' }: PawSvgProps) => (
    <svg
        ...
        fill="none"
    >
        <circle cx="4.5" cy="9.5" r="2.5" fill={fill} />
        <circle cx="9" cy="5.5" r="2.5" fill={fill} />
        <circle cx="15" cy="5.5" r="2.5" fill={fill} />
        <circle cx="19.5" cy="9.5" r="2.5" fill={fill} />
        <path
